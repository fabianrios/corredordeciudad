class EventosController < ApplicationController
  ...
  private
    ...
    def evento_params
      params.require(:evento).permit(:nombre, :lugar, :direccion, :espacio, :necesidades, :descripcion, :web, :cuando, :imagen, :duracion, :user_id, :publish, :lat, :long, :organiza,  {:tag_list => []})
    end
end
